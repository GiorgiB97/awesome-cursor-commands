...
3. Sign in with test credentials (email: `test@example.com`, password: `Test123!`)
4. Verify JWT token in localStorage and included in API requests
5. Access `/dashboard` (protected route) - should load successfully
6. Log out and try accessing `/dashboard` - should redirect to login
7. Test roles: create users with different roles, verify permissions
...
Generate PR description and output directly to user.
